...
## Queries definition
The following queries mimic all **Assertion status** which has been defined in [**Assertion vs. Non-assertion logic**](../conjectures-rdf/expressing-without-asserting-efficiency-datasets). 
